      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-end mb-12">
          ...
          <p className="text-[17px] text-brand-gray leading-relaxed font-light">
            Watch how a scaffolding business goes from chaos to clarity — from first quote through to final sign-off — in under 5 minutes.
          </p>
        </div>
        ...
        <div
          ...
          style={{ borderColor: '#2a2a2a', boxShadow: '0 24px 80px rgba(0,0,0,0.18)' }}
        >
          {/* ARCADE EMBED START */}
          <div style={{ position: 'relative', paddingBottom: 'calc(53.7153% + 41px)', height: 0, width: '100%' }}>
            <iframe
              src="https://demo.arcade.software/mFjxSydheV9ZK25ATcjr?embed&embed_mobile=tab&embed_desktop=inline&show_copy_link=true"
              title="Invite a New Team Member to EdgeOps"
              frameBorder="0"
              loading="lazy"
              allowFullScreen
